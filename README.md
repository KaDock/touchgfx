...
XQuartz should be installed (via brew or other means - remember to relog)
    ...
    docker run -it --rm --env=DISPLAY=10.192.0.179:0 -v $(pwd)/touchgfx-4.6.1-eval/app/example/clock_example:/app:Z -v $(pwd)/touchgfx-4.6.1-eval/touchgfx:/touchgfx:Z kalledk/touchgfx clean run
